        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            <li class="with-x" v-if="options.categoryName">
              {{ options.categoryName }}<i @click="removeCategory">x</i>
            </li>
            <li class="with-x" v-if="options.keyword">
              {{ options.keyword }}<i @click="removeKeyword">x</i>
            </li>
            <li class="with-x" v-if="options.trademark">
              {{ options.trademark }}<i @click="removeTrademark">x</i>
            </li>
            <li
              class="with-x"
